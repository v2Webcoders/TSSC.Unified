...
!function (NioApp, $) {
  ...
  var totalRoom = {
    ...
    datasets: [{
      label: "User",
      color: [NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), "#0f5fa8"],
      // @v2.0
  ...
  var totalBooking = {
    ...
    datasets: [{
      label: "User",
      color: [NioApp.hexRGB("#4f9fd8", .2), NioApp.hexRGB("#4f9fd8", .2), NioApp.hexRGB("#4f9fd8", .2), NioApp.hexRGB("#4f9fd8", .2), NioApp.hexRGB("#4f9fd8", .2), NioApp.hexRGB("#4f9fd8", .2), "#4f9fd8"],
      // @v2.0
