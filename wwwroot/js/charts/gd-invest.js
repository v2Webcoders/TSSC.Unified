!(function (NioApp, $) {
    ...
    var totalDeposit = {
        ...
        datasets : [{
            label : "Active User",
            color : [NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), "#0f5fa8"], // @v2.0
    ...
    var totalWithdraw = {
        ...
        datasets : [{
            label : "Active User",
            color : [NioApp.hexRGB("#4f9fd8", .2), NioApp.hexRGB("#4f9fd8", .2), NioApp.hexRGB("#4f9fd8", .2), NioApp.hexRGB("#4f9fd8", .2), NioApp.hexRGB("#4f9fd8", .2), NioApp.hexRGB("#4f9fd8", .2), "#4f9fd8"],  // @v2.0
            data: [7200, 8200, 7800, 9500, 5500, 9200, 9690]
        }]
    };
    ...
    var planPurchase = {
        ...
        datasets : [{
            label : "Active User",
            color : NioApp.hexRGB("#0f5fa8", .2), //@v2.0
            colorHover : "#0f5fa8", //@v2.0
