!(function (NioApp, $) {
    ...
    var profileBalance = {
        ...
        datasets : [{
            ...
            color : "#2d7dc4",
            background : NioApp.hexRGB('#2d7dc4',.3),
    ...
    var salesRevenue = {
        ...
        datasets : [{
            label : "Sales Revenue",
            color : [NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), "#0f5fa8"], //@v2.0
    ...
    var activeSubscription = {
        ...
        datasets : [{
            label : "Active User",
            color : [NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), NioApp.hexRGB("#0f5fa8", .2), "#0f5fa8"], //@v2.0
    ...
    var totalSubscription = {
        ...
        datasets : [{
            label : "Active User",
            color : [NioApp.hexRGB("#7fb4de", .2), NioApp.hexRGB("#7fb4de", .2), NioApp.hexRGB("#7fb4de", .2), NioApp.hexRGB("#7fb4de", .2), NioApp.hexRGB("#7fb4de", .2), "#7fb4de"], //@v2.0
            data: [8200, 7800, 9500, 5500, 9200, 9690]
        }]
    };
